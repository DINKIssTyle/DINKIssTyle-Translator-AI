...
## 
## For development first run the Wails v3 NSIS task to populate "wails_tools.nsh":
...
####
## !define INFO_PROJECTNAME    "my-project" # Default "dkst-translator-ai"
## !define INFO_COMPANYNAME    "My Company" # Default "DINKIssTyle"
## !define INFO_PRODUCTNAME    "My Product Name" # Default "DKST Translator AI"
## !define INFO_PRODUCTVERSION "1.0.0"     # Default "1.0.0"
## !define INFO_COPYRIGHT      "(c) Now, My Company" # Default "© 2026, DINKIssTyle"
###
